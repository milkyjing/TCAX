...
static tcas_bool tcas_render(TcasStPtr pTcas1, TcasStPtr pTcas2, TCAS_pFile pOutFile, int n) {
    ...
    chunk.startTime = (tcas_unit)((tcas_u64)n * pTcas1->fpsDenominator * 1000 / pTcas1->fpsNumerator);
    chunk.endTime = (tcas_unit)((tcas_u64)(n + 1) * pTcas1->fpsDenominator * 1000 / pTcas1->fpsNumerator);
    chunk.cltp = 0;
