 ...
 */
extern TCAS_Error_Code libtcas_frame_cache_init(const char *filename, tcas_u32 fpsNumerator, tcas_u32 fpsDenominator, tcas_u16 width, tcas_u16 height, int maxFrameCount, int fileCacheSize, TCAS_pFrameCache pFrameCache);
 ...
 */
extern int libtcas_frame_cache_get(TCAS_pFrameCache pFrameCache, tcas_u32 n, tcas_byte **pBuf);
